  ...
  const fetchData = async () => {
    if (deviceWidth < 768) {
      const mobileData = await fetch(
        "https://corsproxy.org/?https%3A%2F%2Fwww.swiggy.com%2Fmapi%2Fhomepage%2FgetCards%3Flat%3D26.876313600000024%26lng%3D81.02215679999999"
      );
      const mobJson = await mobileData.json();
      const alterData =
        mobJson?.data?.success?.cards[4]?.gridWidget?.gridElements
